...
public class virtualWalkTeleTwoBoth : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        filePath = "./file/" + "virtualWalkTeleTwoBoth" + localDateTime + ".csv";
    ...
    public void file()
    {
        ...
        sb.AppendLine("virtualWalkTeleTwoBoth" + ',' + objectSideStr + ',' + handUsedStr + ',' + setCompleted + ',' + currentDensity + ',' + currentWidth * 10 + ',' + completionTime + ',' + errorCount);
