...
public class actualWalkOne : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        filePath = "./file/" + "actualWalkOne" + localDateTime + ".csv";
    ...
    public void file()
    {
        ...
        sb.AppendLine("actualWalkOne" + ',' + objectSideStr + ',' + handUsedStr + ',' + setCompleted + ',' + currentDensity + ',' + currentWidth * 10 + ',' + completionTime + ',' + errorCount);
