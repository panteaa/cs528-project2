...
public class withoutWalkOne : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        filePath = "./file/" + "withoutWalkOne" + localDateTime + ".csv";
    ...
    public void file()
    {
        ...
        sb.AppendLine("withoutWalkOne" + ',' + objectSideStr + ',' + handUsedStr + ',' + setCompleted + ',' + currentDensity + ',' + currentWidth * 10 + ',' + completionTime + ',' + errorCount);
