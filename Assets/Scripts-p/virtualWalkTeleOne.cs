...
public class virtualWalkTeleOne : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        filePath = "./file/" + "virtualWalkTeleOne" + localDateTime + ".csv";
    ...
    public void file()
    {
        ...
        sb.AppendLine("virtualWalkTeleOne" + ',' + objectSideStr + ',' + handUsedStr + ',' + setCompleted + ',' + currentDensity + ',' + currentWidth * 10 + ',' + completionTime + ',' + errorCount);
