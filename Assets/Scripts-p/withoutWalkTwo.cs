...
public class withoutWalkTwo : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        filePath = "./file/" + "withoutWalkTwo" + localDateTime + ".csv";
    ...
    public void file()
    {
        ...
        sb.AppendLine("withoutWalkTwo" + ',' + objectSideStr + ',' + handUsedStr + ',' + setCompleted + ',' + currentDensity + ',' + currentWidth * 10 + ',' + completionTime + ',' + errorCount);
